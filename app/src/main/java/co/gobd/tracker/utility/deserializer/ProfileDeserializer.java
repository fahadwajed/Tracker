 ...
 */
public class ProfileDeserializer implements JsonDeserializer<co.gobd.tracker.model.job.Profile> {

    co.gobd.tracker.model.job.Profile Profile;

    @Override
    public co.gobd.tracker.model.job.Profile deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException {
