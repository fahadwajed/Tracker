...
public class JobModelDeserializer implements JsonDeserializer<JobModel> {
    ...
    public JobModel deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context)
        ...
        Order Order = context.deserialize(jsonObject.get("Order"), co.gobd.tracker.model.job.order.Order.class);
        User User = context.deserialize(jsonObject.get("User"), co.gobd.tracker.model.job.User.class);
